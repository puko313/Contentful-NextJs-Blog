...
export default function Nav() {
    ...
    const NAV_MENU = publicRuntimeConfig.NAV_MENU;
    return (
        <>
                ...
                <div className="container px-6 py-4 mx-auto lg:flex lg:justify-between lg:items-center">
                    <div className="lg:flex lg:items-center">
                        <div className="flex items-center justify-between">
                            <div>
                                <a href="/" className="text-2xl font-bold text-gray-800 transition-colors duration-200 transform lg:text-3xl hover:text-gray-700 "
                                >
                                    BRAND
                                </a>
                            </div>
                        ...
                        <div
                            className="flex flex-col text-gray-600 capitalize   lg:flex lg:px-16 lg:-mx-4 lg:flex-row lg:items-center">

                            {NAV_MENU && NAV_MENU.map((menu, i) => (
                                <a key={i}
                                   href={menu.path}
